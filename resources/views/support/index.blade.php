        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="alert alert-info">
                    Seu formulário será enviado para o suporte e será atendido em breve. Entraremos em contato através do
                    email fornecido. Obrigado!
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('support.send') }}">
                            ...
                            <div class="mb-3 row">
                                <label for="name"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Seu nome') }}</label>
