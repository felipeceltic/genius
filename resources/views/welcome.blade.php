                ...
                <div class="row gx-5 align-items-center justify-content-center">
                    <div class="col-lg-8 col-xl-7 col-xxl-6">
                        <div class="my-5 text-center text-xl-start">
                            <h2 class="fw-bolder text-white mb-2">Fique um passo à frente da complexidade
                            </h2>
                            <p class="lead fw-normal text-white-50 mb-4">Simplifique sua vida com nossa poderosa aplicação. <br> Estamos aqui para você!</p>
                    ...
                    <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center"><img class="img-fluid rounded-3 my-5"
                            src="{{ asset('svg/logo-withoutbg.svg') }}" alt="..." /></div>
                </div>
            </div>
        </div>
        <!-- Contato -->
